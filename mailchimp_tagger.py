...
Tag Mailchimp audience members by matching full names from a plain CSV
list against your existing Mailchimp audience.

Useful any time you have a name list from somewhere that isn't already
synced to Mailchimp (an event roster, a waitlist, a check-in export, a
partner's spreadsheet) and want to tag those contacts for a segmented
send without looking each one up by hand.
